...
def get_arg_parser():
    ...
    parser.add_argument('--data_dir', type=str, default='/dfs/scratch0/lorr1/bootleg/data/personal', help='Where files saved')
    parser.add_argument('--out_subdir', type=str, default='filtered_data', help='Where files saved')
...
def filter_data(num_processes, data_file, output_file):
    st = time.time()
...
def main():
    ...
    for file in in_files:
        ...
        filter_data(args.processes, file, out_file)
