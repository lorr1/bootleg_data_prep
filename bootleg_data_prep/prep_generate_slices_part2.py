...
def parse_args():
    ...
    parser.add_argument('--kg_adj', type=str, default='kg_adj_0905.txt')
    parser.add_argument('--kg_triples', type=str, default='kg_triples_0905.txt')
    ...
    parser.add_argument('--wd_vocab', type=str, default='wikidata_to_typeid_0905.json')
    parser.add_argument('--wd_types', type=str, default='wikidata_types_0905.json')
    parser.add_argument('--rel_vocab', type=str, default='relation_to_typeid_0905.json')
    parser.add_argument('--rel_types', type=str, default='kg_relation_types_0905.json')
