echo
echo "=============================================================================="
echo "Step step4d-copy-to-embs"
echo "=============================================================================="
echo
source ./envs.bash
mkdir -p $BOOTLEG_WIKIPEDIA_DIR/embs
...
cp $BOOTLEG_WIKIDATA_DIR/wikidata_output/qid2desc.json $BOOTLEG_WIKIPEDIA_DIR/embs/qid2desc.json
echo "Copied to: $BOOTLEG_WIKIPEDIA_DIR/embs"