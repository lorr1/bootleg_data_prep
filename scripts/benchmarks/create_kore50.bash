...
KORE50_BENCHMARK_OUTPUT=$BOOTLEG_BENCHMARK_OUTPUT/kore50_$BOOTLEG_LANG_CODE

rm -rf $KORE50_BENCHMARK_OUTPUT
mkdir -p $BOOTLEG_BENCHMARK_OUTPUT
mkdir -p $KORE50_BENCHMARK_OUTPUT

cd $BOOTLEG_PREP_CODE_DIR
...
cp -r $BOOTLEG_PREP_WIKIPEDIA_DIR/data/wiki_dump/kore50_aliases_filtered_0_-1_final $BOOTLEG_PREP_OUTPUT_DIR
